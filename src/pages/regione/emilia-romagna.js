      ...
      {isLoaded ? (
        ...
        <>
          ...
          <div className="RegionDetails">
            <span className="RegionName">Emilia-Romagna</span>
            <Share />
...
export default () => (
  <StaticQuery
    query={graphql`
      query EmiliaRomagna {
        allRtCsv(filter: { state: { eq: "Emilia-Romagna" } }) {
          totalCount
          edges {
            node {
              id
    ...
    `}
    render={data => <EmiliaRomagna data={data} />}
  />
)
