      ...
      {isLoaded ? (
        ...
        <>
          ...
          <div className="RegionDetails">
            <span className="RegionName">Basilicata</span>
            <Share />
...
export default () => (
  <StaticQuery
    query={graphql`
      query Basilicata {
        allRtCsv(filter: { state: { eq: "Basilicata" } }) {
          totalCount
          edges {
            node {
              id
    ...
    `}
    render={data => <Basilicata data={data} />}
  />
)
