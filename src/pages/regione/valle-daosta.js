      ...
      {isLoaded ? (
        ...
        <>
          ...
          <div className="RegionDetails">
            <span className="RegionName">Valle D'Aosta</span>
            <Share />
...
export default () => (
  <StaticQuery
    query={graphql`
      query ValleDAosta {
        allRtCsv(filter: { state: { eq: "Valle d'Aosta" } }) {
          totalCount
          edges {
            node {
              id
    ...
    `}
    render={data => <ValleDAosta data={data} />}
  />
)
