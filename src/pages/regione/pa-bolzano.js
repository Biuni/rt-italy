      ...
      {isLoaded ? (
        ...
        <>
          ...
          <div className="RegionDetails">
            <span className="RegionName">P.A. Bolzano</span>
            <Share />
...
export default () => (
  <StaticQuery
    query={graphql`
      query Bolzano {
        allRtCsv(filter: { state: { eq: "P.A. Bolzano" } }) {
          totalCount
          edges {
            node {
              id
